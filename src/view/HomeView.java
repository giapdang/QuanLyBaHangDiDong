...
public class HomeView extends JFrame {
    ...
    public void HomeUi() {
        ...
        Dimension fixedWidth = new Dimension(200, 0);
    ...
    private JPanel createSanPhamPanel() {
        ...
        int width = (int) (1200 * (dpi / 96.0));
        int height = (int) (600 * (dpi / 96.0));
    ...
    private JPanel createHoaDonPanel() {
        ...
        table_hoadon = new JTable(new DefaultTableModel(
                new Object[]{"ID Hoá Đơn", "Tên Khách Hàng", "Địa Chỉ", "Email", "Số Điện Thoại",
                    "Ngày Tạo Đơn Hàng", "ID Sản Phẩm", "Mã Sản Phẩm", "Tên Sản Phẩm", "Giá Bán", "Số Lượng", "Tổng Tiền Đơn Hàng",
...
////        List<Item> nhaCungCapNames = khachhangService.;
//        CbtenKhachhangdonhang = new JComboBox<>();
...
//        H.add(CbtenKhachhangdonhang);
        ...
        table_donhang = new JTable(new DefaultTableModel(
                new Object[]{"ID Đơn Hàng", "Ngày Tạo Đơn Hàng", "Thành Tiền", "Trạng Thái Đơn Hàng", "Tên Khách Hàng"}, 0
        ));
    ...
    private JPanel createKhoHangPanel() {
        ...
        CbTenNhaCungCapkhohang.setPreferredSize(new Dimension(200, CbTenNhaCungCapkhohang.getPreferredSize().height));
        ...
        CbTenNguoiNhapkhohang.setPreferredSize(new Dimension(200, CbTenNguoiNhapkhohang.getPreferredSize().height));
        ...
        table_khohang = new JTable(new DefaultTableModel(
                new Object[]{"ID Kho", "Tên Sản Phẩm", "Số Lượng", "Ngày Nhập", "Tên Nhà Cung Cấp", "Tên Người Nhập"}, 0
        ));
    ...
    private JPanel creatchitietdonhangPanel() {
        ...
        table_chitietdonhang = new JTable(new DefaultTableModel(
                new Object[]{"ID Chi Tiết Đơn Hàng", "ID Đơn Hàng", "Tên Sản Phẩm", "Tên Khách Hàng", "Số Lượng", "Giá Bán"}, 0
        ));

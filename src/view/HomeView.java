...
public class HomeView extends JFrame {
        ...
        private JPanel createDonHangPanel(){
            ...
            lbidKhachhang = new JLabel("ID Khách Hàng:");
            TfidKhachhang = new JTextField(20);
            ...
            setLabelSize(lbidKhachhang, labelSize);
            ...
            addComponent(subrow1_2, lbidKhachhang, gbc, 0, 3);
            addComponent(subrow1_2, TfidKhachhang, gbc, 1, 3);
            row_1.add(subrow1_2);
            panel.add(row_1);
             JPanel row_2 = new JPanel();
            row_2.setLayout(new FlowLayout(FlowLayout.CENTER, 20, 20));
            ...
            table_donhang = new JTable(new DefaultTableModel(
                    new Object[]{"ID Đơn Hàng", "Ngày Tạo Đơn Hàng", "Thành Tiền", "Trạng Thái Đơn Hàng", "ID Khách Hàng"}, 0
            ));
